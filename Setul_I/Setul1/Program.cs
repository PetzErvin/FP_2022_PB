        ...
        static void Main(string[] args)
        {
            ...
            static void P6()
            {
                ...
                if (a > 0 && b > 0 && c > 0 && a < b + c && b < a + c && c < a + b)
                    Console.WriteLine("Nr pot forma un triunghi");
                else
                    Console.WriteLine("Nr nu pot forma triunghi");
            }
            /// <summary>
            ...
            static void P15()
            {
                ...
                Console.WriteLine($"Cele 3 numere in ordine crescatoare sunt: {min}, {a + b + c - (max + min)} si {max}");
            }
            /// <summary>
            ...
            {
                int x, nr;
                Random r = new Random(); x = r.Next(1, 1024);
                do
                {
                    Console.WriteLine("Dati un nr cuprins intre 1 si 1024");
